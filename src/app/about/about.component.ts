...
export class AboutComponent implements OnInit {
  faqItems = [
    ...
    { expanded: false, question: 'Will there be other questions?', answer: 'For sure at some point there will be more questions. The real question is: is there an answer to all these questions? Who knows!?'},
  ];
